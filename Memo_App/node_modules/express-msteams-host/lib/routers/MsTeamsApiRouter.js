    ...
    var _loop_1 = function (app) {
        if (components.hasOwnProperty(app)) {
            ...
            if (Reflect.hasMetadata("msteams:bot", component)) {
                ...
                var conversationState_1;
                // Create the conversation state
                conversationState_1 = new botbuilder_core_1.ConversationState(botSettings.storage, botSettings.namespace);
                ...
                // Create the Bot
                var bot_1 = new component(conversationState_1, adapter_1);
